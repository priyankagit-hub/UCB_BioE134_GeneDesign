...
def main():
    # Example usage
    sequences = [
        ("AAAAAAAAAAAAAAAAAAAAAAAAAAA", "Zero hairpins"),
        ("AAAAACCCAAAAAAAAAAGGGAAAAAA", "CCC-N10-GGG"),
        ("AAAAACCCAAAAAAAAAGGGAAAAAA", "CCC-N9-GGG"),
        ("AAAAACCCCAAAAAAAAGGGGAAAAAA", "CCCC-N8-GGGG"),
        ("AAAAACACGAAAAAAAACGTGAAAAAA", "CACG-N8-CGTG"),
        ("AAAACCCCCAAAAAAAAGGGGGAAA", "CCCCC-N8-GGGGG"),
        ("AAAACCCCCAAAAAAAGGGGGAAA", "CCCCC-N7-GGGGG")
    ]
    
    for seq, label in sequences:
        count = hairpin_counter(seq)
        print(f"{label}: {count}")
